...
parser.add_argument('-sel_pro', help="essential only =1 , essential + options 1 =2 , essential + options 2 =3 , ALL =4")
parser.add_argument('-sel_print', help="essential + options 1 =1 , essential + options 2 =2")


#read the json file
with open("./auto_program.json", "r") as file_list:
    list_data = json.load(file_list)

with open("./auto_print.json", "r") as file_list_print:
...
os.system(r"net use z: \\[PATH] /user:[USERNAME] [PASSWORD]")
